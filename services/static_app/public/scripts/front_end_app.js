...
var app = {
	...
	read_api: function() {
		axios({ method:'get', url:'http://localhost:3001/get'}) // axios call to get the data
			.then((response) => {
	...
	update_api: function() {	
		...
		axios({ method: 'post', url: dest_url }) // axios call to get the data
				.then((response) => {
	...
	//	view stuff
	initialize: function() {
		console.log('hi');		this.render_input();
		this.render_display();
		this.read_api();
	},
